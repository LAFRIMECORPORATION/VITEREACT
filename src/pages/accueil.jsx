        ...
        const fecthProjets =
            async () => {
                ...
                try {
                    ...
                    const res = await axios.get(`${import.meta.env.VITE_APT_URL}/gesAccueil?page=${page}`, {
                        headers: {
            ...
            {projets.map((projets, index) => (
                <div key={index} className="card">
                    <div className='card-header'>
                        <img src={`${import.meta.env.VITE_BACKENDE_URL}/uploads/${projets.photo_profil}`} alt="profil" className="profil-pic" />
                        <div>
                    ...
                    <div className="post-body">
                        ...
                        {projets.fichier && <img src={`${import.meta.env.VITE_BACKENDE_URL}/uploads/${projets.fichier}`} alt="projet" className='projet-image' />}
                    </div>
                    {/*like et commentaire*/}
